...
game_result = "Game Over" # 기본 메시지 설정
...
while running: # 게임이 진행중인 동안
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3 : # 가장 작은 공이 아니라면 (다음 단계의 공으로 나누기)
                    # 현재 공 크기 정보 가져오기
    ...
    timer = game_font.render("Time : {}".format(int(total_time - elapsed_time)), True, (255, 255, 255)) # (255, 255, 255)는 흰색, (255, 255, 0)은 노란색
    screen.blit(timer, (10, 10)) # 시간을 10, 10의 위치에 놓기
